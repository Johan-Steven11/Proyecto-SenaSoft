...
<head>
   ...
   <!-- fevicon -->
   <link rel="icon" href="img/ImgI/fevicon.png" type="img/ImgI/gif" />
...
<body class="main-layout">
   <!-- loader  -->
   <div class="loader_bg">
      <div class="loader"><img src="img/ImgI/loading.gif" alt="#" /></div>
   </div>
   <!-- end loader -->
   <!-- header -->
   <header>
               ...
               <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                  <nav class="navigation navbar navbar-expand-md navbar-dark ">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        ...
                        <div class="sign_btn"><a href="Login.php">Inicio de sesion</a></div>
                     </div>
                  </nav>
               </div>
            </div>
   ...
   <!-- end header -->
   <!-- banner -->
   <section class="banner_main" id="x">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="text-bg">
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="row">
                  <div class="col-md-12">
                     <div class="img_box">
                        <figure><img src="img/ImgI/img1.jpg" alt="#" /></figure>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="img_box">
                        <figure><img src="img/ImgI/img2.jpg" alt="#" /></figure>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="img_box">
                        <figure><img src="img/ImgI/img3.jpg" alt="#" /></figure>
                     </div>
                  </div>
               </div>
            </div>
   ...
   <div class="our">
      <div class="container">
         <div class="row d_flex">
            <div class="col-md-6">
               <div class="img_box">
                  <figure><img src="img/ImgI/img4.jpg" alt="#" /></figure>
               </div>
            </div>
            <div class="col-md-6">
               <div class="our_box">
      ...
      <div class="footer">
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>Competencia <a id="Senas" href="https://www.sena.edu.co/es-co/comunidades/aprendices/Paginas/senaSoft.aspx">Senasoft </a>2021 vertical 1</p>
                  </div>
               </div>
            </div>
         </div>
   ...
   <!-- Javascript files-->
   <script src="java_index/jquery.min.js"></script>
   <script src="java_index/popper.min.js"></script>
   <script src="java_index/bootstrap.bundle.min.js"></script>
   <script src="java_index/jquery-3.0.0.min.js"></script>
   <script src="java_index/plugin.js"></script>
   <!-- sidebar -->
